 ...
 *
 * $Id: XMLTemplateRenderer.java 114 2005-12-09 15:51:51Z christianc $
 */
...
public class XMLTemplateRenderer extends XMLComponentRenderer {
    ...
    protected static final Logger logger = Logger.getLogger(XMLTemplateRenderer.class.getName());
